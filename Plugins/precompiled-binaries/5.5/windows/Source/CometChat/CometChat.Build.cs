...
public class CometChat : ModuleRules
{
    public CometChat(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        if (Target.Platform == UnrealTargetPlatform.Win64)
        {
            ...
            PublicAdditionalLibraries.Add(Path.Combine(ThirdPartyPath, "lib", "Win64", "ixwebsocket.lib"));
            PublicAdditionalLibraries.Add(Path.Combine(ThirdPartyPath, "lib", "Win64", "libcurl.lib"));
            PublicAdditionalLibraries.Add(Path.Combine(ThirdPartyPath, "lib", "Win64", "libssl.lib"));
            PublicAdditionalLibraries.Add(Path.Combine(ThirdPartyPath, "lib", "Win64", "libcrypto.lib"));
            ...
            PublicSystemLibraries.Add("normaliz.lib");
            
            // zlib from UE's bundled ThirdParty
